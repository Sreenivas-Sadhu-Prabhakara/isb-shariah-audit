package com.bank.islamic.shariahaudit.model;
...
/**
 * The BIAN control record for this service domain: "Shariah Audit Engagement Assessment".
 *
 ...
 * to its asset type (Shariah Audit Engagement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Shariah Audit Engagement Assessment";
